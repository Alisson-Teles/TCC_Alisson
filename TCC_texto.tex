...
Além disso, a figura \ref{fig:minhafigura8} evidencia uma limitação importante do conjunto de dados utilizado. Observa-se que, em 56,2\% dos programas, as sequências de passes propostas por \citeonline{faustino2021new} produzem códigos menores do que a \textit{flag} padrão -Oz, enquanto em 43,6\% dos casos o resultado é equivalente e apenas 0,2\% há piora. Esse comportamento indica que o \textit{dataset} empregado neste trabalho está fortemente enviesado para programas nos quais as sequências de \citeonline{faustino2021new} já são muito competitivas, muitas vezes dominando a configuração padrão do compilador. Em outras palavras, o modelo é treinado majoritariamente em exemplos que já existe uma sequência de otimização bastante ajustata ao conjunto de \textit{benchmarks} de origem, o que reduz o espaço de melhoria e pode mascarar limitações da abordagem quando aplicada a códigos mais variados.
